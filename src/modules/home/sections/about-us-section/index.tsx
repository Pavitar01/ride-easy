  ...
  return <Box className="about-us-section">
    <Container maxWidth="lg" className="container">
      ...
      <Box className="about-us-right-section">
        ...
        <Typography component='h1' className="about-us-heading"
          sx={{
            fontSize: {
        ...
        <Typography component="p" className="about-us-description">
          Unlock the freedom to ride with RideEasy’s bike and scooter rentals. Whether you need a scooter for city commutes or a bike for adventure, we offer the perfect two-wheeler for your journey.
        </Typography>
        <BaseButton sx={{
          marginTop: "32px", width: {
            md: "max-content",
            xs: "100%"
          }
        }}>Discover More</BaseButton>
      </Box>
    </Container>
  </Box>
}
